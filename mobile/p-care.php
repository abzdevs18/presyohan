...
<div class="nav-wrapper">
		<a href="index.php" class="left"><i style="color:#ff5a2a;" class="material-icons right">arrow_back</i></a>
 		<strong style="font-size:20px;padding-left:5px;color:#ff5a2a;">Personal Care</strong>
...
<?php
include 'db_connect.php';
$sql="SELECT * FROM products WHERE prod_category = 'Personal Care'";
...
<li><div class="card">
    ...
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4"><strong><?php echo $rows['prod_name']; ?> - <?php echo $rows['prod_price']; ?></strong>
